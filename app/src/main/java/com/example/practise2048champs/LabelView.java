...
public class LabelView extends View {
    ...
    private void init() {
        // Adjust the labelWidth as per the requirement
        labelWidth = 60;
        ...
        labelColor = Color.parseColor("#EE4B2B"); // Label's main color
        pointColor = Color.parseColor("#D22B2B"); // Folded shadow's color

        // Adjust the text to suit your requirement
        text = "HOT!";
        // Adjust the text color to suit your requirement
    ...
    public void draw(Canvas canvas) {
        ...
        float textX = width / 2;
        // Ordinate of text center point (Denominator is taken 2.1f to better align text in center)
        float textY = (height - pointWidth - (labelWidth / 2f)) / 2.1f;
